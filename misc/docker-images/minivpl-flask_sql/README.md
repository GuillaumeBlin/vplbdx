# VPLBdx Project related docker image for FLASK + SQL programming facility
...
This image is the docker image inheriting from [gblin/minivpl](https://hub.docker.com/r/gblin/minivpl) and dedicated to FLASK and SQL programming.
