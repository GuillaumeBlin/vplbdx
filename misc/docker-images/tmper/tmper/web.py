...
#=============================================================================
DEFAULT_ROOT = os.path.join(os.getcwd(), './.tmper-files/transfer.sh/')
...
class MainHandler(Handler):
    ...
    def post(self, args):
        ...
        if len(self.request.files) == 1:
            ...
            if meta['n'] < 0 :
                logging.info("here")
                td=tempfile.mkdtemp(dir="/home/blin/tmper-master/permanent/")
            ...
            self.write("https://services.emi.u-bordeaux.fr/transfer.sh/"+name)
            self.finish()
...
def serve(root=None, port='1443', addr='10.0.252.106'):
    global files
    files = FileManager()
    files.init(root)
