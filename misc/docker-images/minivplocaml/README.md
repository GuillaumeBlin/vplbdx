# VPLBdx Project related docker image for OCaml programming facility
...
This image is the docker image inheriting from [gblin/minivpl](https://hub.docker.com/r/gblin/minivpl) and dedicated to OCaml programming.
